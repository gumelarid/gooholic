        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="form-group form-floating-label">
                    <input name="slug" id="slug" type="text" class="form-control input-border-bottom text-primary font-italic" value="{{ $article->slug_article }}" required>
                ...
                @enderror
                <div class="form-group form-floating-label">
					<input name="title" id="title" type="text" class="form-control input-border-bottom" required onkeyup="createTextSlug()" value="{{ $article->title }}" autofocus>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="editor" class="form-control input-border-bottom">{{ $article->description }}</textarea>
                </div>
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12 mb-2">
                        <img id="preview-image-before-upload" src="{{ $article->cover ? url('assets/image/article/'.$article->cover ) : 'https://www.riobeauty.co.uk/images/product_image_not_found.gif' }}"
                ...
                <div class="form-group">
                    ...
                    <textarea name="subject" class="form-control input-border-bottom" maxlength="250">{{ $article->subject }}</textarea>
                </div>
                <div class="form-group form-floating-label">
                    <label>Status</label>
                    @error('status')
                ...
                <div class="form-group form-floating-label">
                    ...
                    <select name="category" class="form-control input-border-bottom" required>
                        @foreach ($category as $item)
                            <option value="{{ $item->id_category }}" {{ $item->id_category == $article->id_category ? 'selected' : '' }}>{{ $item->category }}</option>
                        @endforeach
                    </select>
				</div>
